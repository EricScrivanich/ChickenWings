//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
//	DespawnerEventOnCollision2DEnter.cs
...
namespace HellTap.PoolKit {
	...
	public class DespawnerEventOnCollision2DEnter : DespawnerEvent {
		...
		void OnCollisionEnter2D( Collision2D collision ){
			...
			if( despawner != null && despawner.despawnMode == Despawner.DespawnMode.AfterPhysicsCollision2DEvent && despawner.useCollisionEnter2D &&
