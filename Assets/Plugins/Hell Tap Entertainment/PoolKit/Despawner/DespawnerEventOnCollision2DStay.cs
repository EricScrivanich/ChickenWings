//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
//	DespawnerEventOnCollision2DStay.cs
...
namespace HellTap.PoolKit {
	...
	public class DespawnerEventOnCollision2DStay : DespawnerEvent {
		...
		void OnCollisionStay2D( Collision2D collision ){
			...
			if( despawner != null && despawner.despawnMode == Despawner.DespawnMode.AfterPhysicsCollision2DEvent && despawner.useCollisionStay2D &&
